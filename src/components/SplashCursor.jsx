...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(targetCanvas) {
      ...
      let webgl = targetCanvas.getContext('webgl2', params);
      const isWebGL2 = !!webgl;
      if (!isWebGL2) webgl = targetCanvas.getContext('webgl', params) || targetCanvas.getContext('experimental-webgl', params);
