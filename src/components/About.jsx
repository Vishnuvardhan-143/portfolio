              ...
              {cards.map((card, idx) => (
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <span className="inline-block text-xs font-black px-2.5 py-0.5 rounded-full bg-zinc-900/5 dark:bg-white/5 text-cyan-400 border border-zinc-900/5 dark:border-white/5 mt-1">{card.value}</span>
