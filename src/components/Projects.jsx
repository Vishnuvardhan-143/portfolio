...
export default function Projects() {
  ...
  const getTagIcon = (tag) => {
    switch (tag) {
      case 'Distributed Systems': return <Server size={14} className="text-cyan-400" />;
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-20 relative z-10">
        ...
        <div className="flex flex-col items-center gap-3 mb-16 text-center">
          ...
          <div className="w-12 h-1 bg-cyan-400 mt-2 rounded-full" />
        </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    {/* Title & Description */}
                    <h3 className="text-2xl font-black uppercase tracking-wider text-zinc-900 dark:text-white group-hover/card:text-cyan-400 transition-colors">
                      {project.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between border-t border-zinc-900/5 dark:border-white/5 pt-6 mt-6">
                    <button 
                      ...
                      className="text-[10px] font-black uppercase tracking-widest text-cyan-400 hover:opacity-80 transition-opacity cursor-pointer"
                    >
                    ...
                    <a 
                      ...
                      className="p-2.5 rounded-xl bg-zinc-900/5 dark:bg-white/5 border border-zinc-900/5 dark:border-white/5 text-zinc-500 dark:text-zinc-400 hover:border-cyan-400/40 hover:text-cyan-400 transition-all duration-300"
                    >
                      <Github size={14} />
                    </a>
                  </div>
